...
export default async function ProfileCreationPage({ authID }) {
    ...
    <div className="w-full h-full flex items-center justify-center ">
      <div className="divide-y divide-gray-200 overflow-hidden rounded-lg bg-white  shadow-2xl p-8 sm:p-16 sm:w-[80%] h-full overflow-y-auto">
        <div className="px-4 py-5 sm:px-6">
          <h1 className="text-2xl font-semibold">Registro de Conta</h1>
        </div>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
              <div className="px-4 sm:px-0">
                ...
                <p className="mt-1 text-sm leading-6 text-gray-600">
                  Preencha os seguintes campos para completar o registro
                </p>
              </div>
