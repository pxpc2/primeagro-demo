              ...
              >
                <div className="px-4 py-6 sm:p-8">
                  ...
                  <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div className="sm:col-span-full">
                      ...
                      <div className="mt-2">
                        ...
                        >
                          ...
                          <option value="1-Ananas">G04 - Ananás-01-Bico</option>
                    ...
                    <div className="sm:col-span-full">
                      <legend className="text-sm font-semibold leading-6 text-gray-900">
                        ...
                        dimensão da propriedade familiar. (320 hectares, ou 66,1
                        alqueires para grande parte do Tocantins)
                      </legend>
                      ...
                      <div className="mt-6 space-y-6">
                        ...
                        <div className="flex items-center gap-x-3">
                          ...
                          <label
                            ...
                            className="block text-sm font-normal leading-6 text-gray-900"
                          >
                            PNCF - Jovem Terra da Juventude (Renda Anual de até
                            R$ 55.551,98 e Patrimônio de até R$ 140 mil).
                          </label>
                        </div>
                        <div className="flex items-center gap-x-3">
                          <input
                    ...
                    <div className="sm:col-span-full">
                      <legend className="text-sm font-semibold leading-6 text-gray-900">
                        ...
                        participou de algum programa que tenha recursos do Fundo
                  ...
                  <fieldset className="mt-10">
                    <legend className="text-sm font-semibold leading-6 text-gray-900">
                      8. Marque quais dos documentos listados abaixo você possui
                    ...
                    <div className="mt-6 space-y-6">
                      <div className="relative flex gap-x-3">
                        ...
                        <div className="text-sm leading-6">
                          ...
                          >
                            Comprovante de matrícula ou ficha de insc. em escola
                            rural, ata ou boletim escolar do trabalhador ou dos
                            filhos.
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="relative flex gap-x-3">
                        ...
                        <div className="text-sm leading-6">
                          <label
                            ...
                            className="font-normal text-gray-900"
                          >
                            Registro de processos administrativos ou judiciais,
                            inclusive inqueritos, como testemunha, autor ou réu.
                          </label>
                        </div>
                      </div>
                      <div className="relative flex gap-x-3">
                      ...
                      <div className="relative flex gap-x-3">
                        ...
                        <div className="text-sm leading-6">
                          <label
                            ...
                            className="font-normal text-gray-900"
                          >
                            Recibo ou nota fiscal de compra de implementos ou de
                            insumos agrícolas.
                          </label>
                        </div>
                      </div>
                      <div className="relative flex gap-x-3">
                        ...
                        <div className="text-sm leading-6">
                          <label
                            ...
                            className="font-normal text-gray-900"
                          >
                            Publicação na impresa ou informativos de circulação
                            pública.
                          </label>
                        </div>
                      </div>
                      <div className="relative flex gap-x-3">
                        ...
                        <div className="text-sm leading-6">
                          <label
                            ...
                            className="font-normal text-gray-900"
                          >
                            Registro em documentos de associações de produtores
                            rurais, comunitárias, recreativas, desportivas ou
                            religiosas.
                          </label>
                        </div>
                      </div>
                      ...
                      <div className="relative flex gap-x-3">
                        ...
                        <div className="text-sm leading-6">
                          <label
                            ...
                            className="font-normal text-gray-900"
                          >
                            Declaração de aptidão ao Pronaf (DAP) ou Cadastro de
                            agricultura familiar (CAF) - Atualizadas ou antigas
                            (expiradas).
                          </label>
                        </div>
                      </div>
