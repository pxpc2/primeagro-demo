...
/**
 * este formulario eu copiei do form de signup/registro de conta, tem que adaptar algumas partes ainda
 * @todo TROCAR FORM ACTION DE SIGNUP PARA CRIAR NOVA APLICACAO NO BANCO
 *
 */
export default function NovaProposta({ isToggled, onClose, msg }) {
